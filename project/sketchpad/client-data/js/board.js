...
console.log(Tools.board);
console.log("from sketch");
...
(function () {
	...
	console.log(Tools.board);
	console.log(document.getElementById("drawingArea").innerHTML);
	console.log(Tools.board.drawingArea);
})()
